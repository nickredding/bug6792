...
function ajaxpostdata() {
    $.ajax('https://nickredding.ca/bug6792/echopost.php', {method:'POST', data: {a:'x',b:'y'},
    success(response) {
...
function capacitorpostdata() {
   http.request({method: 'POST', url: 'https://nickredding.ca/bug6792/echopost.php', headers: {'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8', Accept: '*/*'}, data: {a:'x',b:'y'}})
   .then(
    function(response) {
...
function capacitorurlcookies() {
    ...
    .then(
        function () {
            ...
            output += 'Setting cookie for domain nickredding.ca via server request<br/><br/>';
            setremotecookie('nrkey1', 'nrvalue1', 'https://nickredding.ca/echo.php', false,
                function(data) {
                    ...
                    setremotecookie('onrkey1', 'onrvalue1', 'https://www.onlinenewsreader.net/echo.php', false,
                        function(data) {
                            ...
                            output += 'Retrieving cookies for domain nickredding.ca<br/><br/>';
                            cookies.getCookies({url:'nickredding.ca'})
                            .then(
                                function(data) {
...
function getcookieexpiry() {
    ...
    for (i=0; i < cookieList.length; i++) {
        ...
        var url = (/^nr/.test(name) ? 'https://nickredding.ca' : 'https://www.onlinenewsreader.net');
